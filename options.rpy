...
python early:
    config.save_directory = "teoria de colas ipsm-1491345541"
...
init -1 python hide:
    ...
    style.menu_choice_button.background = Frame("eleccion.png",28,9)
    style.menu_choice_button.hover_background = Frame("eleccion_hover.png",28,9)
...
init python:
    ...
    build.directory_name = "teoria_de_colas_ipsm-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "teoria_de_colas_ipsm"
